...
/*
        <span>
                    ...
                    <FormControl componentClass="textarea" placeholder= {authUser.displayName}  value={this.state.user}
                                 onChange={event => this.setState(byPropKey('user', event.target.value))}/>
                </span>
 */
...
class Post extends Component {
    ...
    onSubmit = (event) =>       {
        const addroot = app.database().ref().child('app').child('addpost');
        const data = {
            select: {
